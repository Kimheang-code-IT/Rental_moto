...
const columns = computed<TableColumn<Record<string, unknown>>[]>(() => {
  ...
  { accessorKey: 'plate', header: tx('rental.ui.plate', 'Plate') },
  {
    ...
    header: tx('rental.ui.startDate', 'Start Date'),
    cell: ({ row }) => dateTimeCell(row.original.startDate),
  },
  {
    accessorKey: 'dueDate',
    header: tx('rental.ui.dueDate', 'End Date'),
    cell: ({ row }) => dateTimeCell(row.original.dueDate),
  },
  {
    accessorKey: 'returnDate',
    header: tx('rental.ui.returnDate', 'Return Date'),
  ...
  { accessorKey: 'rentalCharge', header: tx('rental.ui.rentalFee', 'Rental Fee'), meta: { class: { td: 'text-end tabular-nums', th: 'text-end' } }, cell: ({ row }) => moneyCell(row.original, 'rentalCharge') },
  ...
  { accessorKey: 'totalDue', header: tx('rental.ui.total', 'Total'), meta: { class: { td: 'text-end tabular-nums', th: 'text-end' } }, cell: ({ row }) => moneyCell(row.original, 'totalDue') },
  {
...
const exportFields = computed<ExportFieldOption[]>(() => [
  ...
  { label: tx('rental.ui.returnDate', 'Return Date'), value: 'returnDate' },
  { label: tx('rental.ui.duration', 'Duration'), value: 'durationDays' },
  { label: tx('rental.ui.rentalFee', 'Rental Fee'), value: 'rentalCharge' },
