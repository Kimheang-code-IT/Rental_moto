    ...
    sections: [
      {
        ...
        fields: [
          ...
          {
            key: 'telegram.connectionMode',
            labelKey: 'rental.settings.connectionMode',
            type: 'select',
            options: [
              { label: 'Bot API / Long Polling', value: 'bot_api' },
          ...
          { key: 'telegram.includeRecordLink', labelKey: 'rental.settings.includeRecordLink', type: 'boolean' },
          { key: 'telegram.includeBusinessName', labelKey: 'rental.settings.includeBusinessName', type: 'boolean' },
          { key: 'telegram.includeAssignedOfficer', labelKey: 'rental.settings.includeAssignedOfficer', type: 'boolean' },
          ...
          { key: 'telegram.passwordResetEnabled', labelKey: 'rental.settings.passwordResetEnabled', type: 'boolean' },
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: '__securityAlert',
            labelKey: 'core.settings.securityDisclaimer',
            type: 'alert',
            helpKey: 'core.settings.securityDisclaimerHelp',
            alertColor: 'warning',
            colSpan: 2,
          },
          { key: 'security.sessionTimeoutMinutes', labelKey: 'core.settings.sessionTimeout', type: 'number' },
          ...
          { key: 'security.jwtAccessTokenMinutes', labelKey: 'rental.settings.jwtAccessTokenMinutes', type: 'number' },
