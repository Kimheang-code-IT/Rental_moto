...
export const rentalModules: ModuleConfig[] = [
  createRentalModule({
    ...
    fields: [
      ...
      rf('dailyRate', '1 Day Rate', 'តម្លៃ ១ ថ្ងៃ', 'Rates', 'អត្រា', 'number', undefined, { required: true, currencyField: 'currency' }),
      rf('threeDayRate', '3 Day Rate', 'តម្លៃ ៣ ថ្ងៃ', 'Rates', 'អត្រា', 'number', undefined, { currencyField: 'currency' }),
      rf('weeklyRate', '1 Week Rate', 'តម្លៃ ១ អាទិត្យ', 'Rates', 'អត្រា', 'number', undefined, { currencyField: 'currency' }),
      rf('monthlyRate', '1 Month Rate', 'តម្លៃ ១ ខែ', 'Rates', 'អត្រា', 'number', undefined, { currencyField: 'currency' }),
  ...
  createRentalModule({
    ...
    columns: [
      ...
      rcol('dueDate', 'End Date', 'ថ្ងៃបញ្ចប់'),
      rcol('durationDays', 'Days', 'ចំនួនថ្ងៃ'),
      rcol('rentalCharge', 'Rental Fee', 'ថ្លៃជួល'),
      rcol('deposit', 'Deposit', 'ប្រាក់កក់'),
      rcol('discount', 'Discount', 'បញ្ចុះតម្លៃ'),
      rcol('totalDue', 'Total', 'សរុប'),
    ...
    fields: [
      ...
      rf('rentalCharge', 'Rental Fee', 'ថ្លៃជួល', 'Balance', 'សមតុល្យ', 'number', undefined, { computed: true }),
      ...
      rf('totalDue', 'Total', 'សរុប', 'Balance', 'សមតុល្យ', 'number', undefined, { computed: true }),
