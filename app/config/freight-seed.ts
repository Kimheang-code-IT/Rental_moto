 ...
 * The freight operational seed (quotations, jobs, shipments, finance…) was
 * removed in the rental cutover — rental demo data lives in `./rental-seed.ts`.
 */
...
/** Administration-only base collections consumed by `createLcsFreightSeed`. */
